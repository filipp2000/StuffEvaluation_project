 ...
 * @author filip
 */
public class WithdrawApplic extends javax.swing.JFrame {

    /**
     * Creates new form WithdrawApplic
     */
    public WithdrawApplic() {
        initComponents();
        showOpenJobApplics();
    }
    ...
    private void initComponents() {
        ...
        jTable_ΟpenJobApplic = new javax.swing.JTable();
        ...
        jLabel4.setText("Withdraw Job Application");
        ...
        jTable_ΟpenJobApplic.setBackground(new java.awt.Color(236, 240, 241));
        jTable_ΟpenJobApplic.setForeground(new java.awt.Color(52, 73, 94));
        jTable_ΟpenJobApplic.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTable_ΟpenJobApplic.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_ΟpenJobApplicMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(jTable_ΟpenJobApplic);
    ...
    private void jTable_ΟpenJobApplicMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_ΟpenJobApplicMouseClicked
        int selectedRow = jTable_ΟpenJobApplic.getSelectedRow();

        CallableStatement cs;

        String proc = "{CALL delete_openJobApplic(?,?)}";

        String username = MenuEmployee.EmployeeUsername;
        String job_id = jTable_ΟpenJobApplic.getValueAt(selectedRow, 0).toString();

        try {
            cs = MySQLconnection.connectDb().prepareCall(proc);

            cs.setString(1, username);
            cs.setString(2, job_id);

            cs.execute();
            JOptionPane.showMessageDialog(null, "Application Withdrawn");

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
        }

    }//GEN-LAST:event_jTable_ΟpenJobApplicMouseClicked
 
    private void showOpenJobApplics(){
        
        CallableStatement cs;
        ResultSet res;

        String proc = "{CALL show_openJobApplic(?)}";
        ...
        try {
            ...
            res = cs.executeQuery();
            jTable_ΟpenJobApplic.setModel(DbUtils.resultSetToTableModel(res));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WithdrawApplic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WithdrawApplic().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_ΟpenJobApplic;
