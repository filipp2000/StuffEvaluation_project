 ...
 * @author filip
 */
public class ViewLogFileUser extends javax.swing.JFrame {

    private String user;
    
    public ViewLogFileUser(String username) {
        initComponents();
        this.user = username;
        showLogFile();
    }

    private ViewLogFileUser() {
    ...
    private void showLogFile(){
        ...
        String proc = "{CALL view_logfileUser(?)}";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLogFileUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLogFileUser().setVisible(true);
            }
        });
    }
