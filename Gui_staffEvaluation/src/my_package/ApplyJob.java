...
public class ApplyJob extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable_OpenJobs = new javax.swing.JTable();
        ...
        jTable_OpenJobs.setBackground(new java.awt.Color(236, 240, 241));
        jTable_OpenJobs.setForeground(new java.awt.Color(52, 73, 94));
        jTable_OpenJobs.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTable_OpenJobs.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_OpenJobsMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(jTable_OpenJobs);
    ...
    private void jTable_OpenJobsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_OpenJobsMouseClicked
       int selectedRow = jTable_OpenJobs.getSelectedRow();
        
        CallableStatement cs;
        
        String proc = "{CALL apply_toJob(?,?)}";    
        
        String username = MenuEmployee.EmployeeUsername;
        String job_id = jTable_OpenJobs.getValueAt(selectedRow, 0).toString();
    ...
    }//GEN-LAST:event_jTable_OpenJobsMouseClicked
    ...
    private void showOpenJobs(){
        ...
        try {
            ...
            res = cs.executeQuery();
            jTable_OpenJobs.setModel(DbUtils.resultSetToTableModel(res));
    ...
    private javax.swing.JTable jTable_OpenJobs;
