 ...
 * @author filip
 */
public class EvaluatorRegisterForm extends javax.swing.JFrame {

    /**
     * Creates new form EvaluatorRegisterForm
     */
    public EvaluatorRegisterForm() {
        initComponents();
        setCompanyAfm();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Evaluator Register ");
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        String procEval = "{CALL eval_insert(?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cs.execute();
            JOptionPane.showMessageDialog(null, "New Evaluator Added");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvaluatorRegisterForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EvaluatorRegisterForm().setVisible(true);
            }
        });
    }
